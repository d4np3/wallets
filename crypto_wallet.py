...
abs_path = os.path.abspath(os.path.join(os.getcwd(), os.pardir, os.pardir))
full_path = os.path.join(abs_path + '/.env')
...
def generate_account():
    ...
    #mnemonic = 'illegal luggage nose gym wool salute trash cancel produce guide smart ginger'
...
def send_transaction(w3, account, to, wage, gas_gwei):
