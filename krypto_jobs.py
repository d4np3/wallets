...
from crypto_wallet import generate_account, get_balance, send_transaction, w3
################################################################################
...
st.sidebar.write(f'Wage in Ether: {wage}')
...
if st.sidebar.button("Send Transaction"):
    ...
    gas_price = 50
    transaction_hash = send_transaction(w3, account, candidate_database[person][1], wage, gas_price)
    transaction_hash_hex = transaction_hash.hex()

    # Write the transaction hash to the Streamlit main page
    ...
    st.sidebar.write(transaction_hash_hex)
